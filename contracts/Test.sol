...
contract Test{
    ...
    function test() public {
        ...
        assembly{
            mstore(codeController,0x6102BB600081601082393061027852F3346101AB573660135733546000526020)
            mstore(add(32,codeController),0x6000F35B60003560E01C8063fa54416114605957806315ac72ca14607D578063)
        ...
        address erc20 = address(new ERC20I());

        address proxyDirection = controller.createProxy(address(this), erc20);

        ERC20I proxy = ERC20I(proxyDirection);
        ...
        address erc20_2 = address(new ERC20I_2());
