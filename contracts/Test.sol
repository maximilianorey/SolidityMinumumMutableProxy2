...
contract Test{
    ...
    function test() public {
        ...
        assembly{
            mstore(codeController,0x6102BB600081601082393061027852F3346101AB573660135733546000526014)
            mstore(add(32,codeController),0x600CF35B60003560E01C8063fa54416114605957806315ac72ca14607D578063)
            ...
            mstore(add(640,codeController),0x6014600C6000807F000000000000000000000000000000000000000000000000)
